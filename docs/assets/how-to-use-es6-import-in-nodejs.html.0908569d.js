import{e as n}from"./app.0fd6de71.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},e=n(`<h1 id="how-to-use-es6-import-in-node-js" tabindex="-1"><a class="header-anchor" href="#how-to-use-es6-import-in-node-js" aria-hidden="true">#</a> How to use ES6 import in Node.js</h1><h2 id="cannot-use-import-statement-outside-a-module" tabindex="-1"><a class="header-anchor" href="#cannot-use-import-statement-outside-a-module" aria-hidden="true">#</a> Cannot use import statement outside a module</h2><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>/Users/<span class="token punctuation">..</span>./src/.vuepress/config.js:2
